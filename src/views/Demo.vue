        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-xl-6 col-md-6">
            <div class="intro-content">
              <h2>The complete Khodo cryptocurrency Exchange VueJS App</h2>
              <p>
        ...
        <div class="row py-lg-5 justify-content-center">
          <div class="col-xl-7">
            <div class="section_heading">
              <span>Explore</span>
              <h3>The Complete Khodo Crafted Design Pages</h3>
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row align-items-center">
          <div class="col-xl-6 col-md-6">
            <div class="copy_right">
              Copyright © {{ new Date().getFullYear() }} Khodo. All Rights
              Reserved.
            </div>
          </div>
          <div class="col-xl-6 col-md-6 text-lg-right text-center">
            <div class="social">
              ...
              ></router-link>
              <router-link to="https://twitter.com/Khodo"
                ><i class="fa fa-twitter"></i
              ></router-link>
              <router-link to="https://www.facebook.com/qxlab"
