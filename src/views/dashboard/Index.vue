                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                <span class="text-primary"
                                  >{{ btc }} {{ currency }} <br />
                                  For {{ mwk_btc_buy.toLocaleString() }} MWK
                                </span>
                              </td>
                              <td
                                v-if="
                              ...
                              >
                                <span class="text-primary"
                                  >{{ eth }} {{ currency }} <br />
                                  For {{ mwk_eth_buy.toLocaleString() }} MWK
                                </span>
                              </td>
                              <td
                                v-if="
                              ...
                              >
                                <span class="text-primary"
                                  >{{ bch }} {{ currency }} <br />
                                  For {{ mwk_bch_buy.toLocaleString() }} MWK
                                </span>
                              </td>
                              ...
                              >
                                <span class="text-primary"
                                  >{{ btc2 }} {{ currency }} <br />
                                  For {{ mwk_btc_sale.toLocaleString() }} MWK
                                </span>
                              </td>
                              <td
                                v-if="
                              ...
                              >
                                <span class="text-primary"
                                  >{{ eth2 }} {{ currency }} <br />
                                  For {{ mwk_eth_sale.toLocaleString() }} MWK
                                </span>
                              </td>
                              <td
                                v-if="
                              ...
                              >
                                <span class="text-primary"
                                  >{{ bch2 }} {{ currency }} <br />
                                  For {{ mwk_bch_sale.toLocaleString() }} MWK
                                </span>
                              </td>
                            </tr>
                            <tr>
...
export default {
  ...
  data() {
   ...
   created: function() {
    ...
    this.connection = new WebSocket("https://khodo-price-ticker.herokuapp.com/")
    //ws://khodl-price-ticker.herokuapp.com/
