      ...
      <div class="row justify-content-center">
        <div class="col-xl-8 col-md-11">
          <div class="testimonial-content">
            ...
            >
              <Slide class="row align-items-center no-gutters">
                ...
                <div class="col-xl-6 col-md-6">
                  <div class="customer-review px-4">
                    ...
                    />
                    <p>
                      Integrating Khodo services into Trezor Wallet's
              ...
              <Slide class="row align-items-center no-gutters">
                ...
                <div class="col-xl-6 col-md-6">
                  <div class="customer-review px-4">
                    ...
                    />
                    <p>
                      MEW is excited to bring Khodo ’s extensive range of
                      Khodo o assets, competitive rates and seamless swap
                      functionality
                    </p>
                    <div class="customer-info">
                      <h5>Mr Abraham</h5>
