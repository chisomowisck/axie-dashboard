      ...
      <div class="row py-lg-5 justify-content-center">
        <div class="col-xl-7">
          <div class="section_heading">
            <span>Features</span>
            <h3>The most trusted Khodo ocurrency platform</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="features-content">
            ...
            <p>
              Khodo ocurrency stored on our servers is covered by our
              insurance policy.
            </p>
            <a href="#">Learn more <i class="la la-angle-right"></i></a>
          </div>
        ...
        <div class="col-md-4">
          <div class="features-content">
            ...
            <p>
              Khodo supports a variety of the most popular digital
              currencies.
            </p>
            <a href="#">Learn more <i class="la la-angle-right"></i></a>
          </div>
