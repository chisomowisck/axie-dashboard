      ...
      <div class="row py-lg-5 justify-content-center">
        <div class="col-xl-7">
          <div class="section_heading">
            <span>Join Us</span>
            <h3>Create your Khodo ocurrency portfolio today</h3>
            <p>
              Khodo has a variety of features that make it the best place to
              start trading
            </p>
          </div>
        </div>
        ...
        <div class="col-xl-6 col-md-6">
          <div class="media">
            ...
            <div class="media-body">
              ...
              <p>
                Invest in Khodo ocurrency slowly over time by scheduling buys
        ...
        <div class="col-xl-6 col-md-6">
          <div class="media">
            ...
            <div class="media-body">
              <h4>Mobile apps</h4>
              <p>
                Stay on top of the markets with the Khodo app for
